...
class ChucVuDetaillAdd extends StatefulWidget {
  final ChucVuItem chucVu;
  ChucVuDetaillAdd(this.chucVu);
  @override
  _ChucVuDetaillAddState createState() => _ChucVuDetaillAddState();
}

class _ChucVuDetaillAddState extends State<ChucVuDetaillAdd> {
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                var chucVuDetail = FirebaseFirestore.instance
                    .collection('chucVuCollection')
                    .doc(widget.chucVu.id)
                    .collection('chucVuDetailCollection');
                String id = chucVuDetail.doc().id;
                chucVuDetail.doc(id).set({
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ChucVuDetail(chucVu: widget.chucVu),
                  ),
                );
              },
            ),
