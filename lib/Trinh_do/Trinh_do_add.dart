...
class TrinhDoAdd extends StatefulWidget {
  @override
  State<TrinhDoAdd> createState() => _TrinhDoAddState();
}

class _TrinhDoAddState extends State<TrinhDoAdd> {
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          trinhDo.doc(id).set(data.toJson());
