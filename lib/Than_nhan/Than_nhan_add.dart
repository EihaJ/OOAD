...
class ThanNhanAdd extends StatefulWidget {
  final NhanVienItem nhanVien;
  ThanNhanAdd(this.nhanVien);
  @override
  State<ThanNhanAdd> createState() => _ThanNhanAddState();
}

class _ThanNhanAddState extends State<ThanNhanAdd> {
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                thanNhan.doc(id).set(data.toJson());
